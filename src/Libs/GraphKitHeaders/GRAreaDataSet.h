...
- (void)drawLegendSampleInRect:(struct _NSRect)fp8;	// IMP=0x4d59347c
- (void)drawDataSetRect:(struct _NSRect)fp8;	// IMP=0x4d593618
- (id)view:(id)fp8 stringForToolTip:(int)fp12 point:(struct _NSPoint)fp16 userData:(void *)fp24;	// IMP=0x4d595c00
