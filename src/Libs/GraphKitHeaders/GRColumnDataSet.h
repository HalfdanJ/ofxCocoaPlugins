...
- (id)copyWithZone:(struct _NSZone *)fp8;	// IMP=0x4d59713c
- (BOOL)supportsRangesOnAxis:(unsigned short)fp8;	// IMP=0x4d597184
- (void)drawLegendSampleInRect:(struct _NSRect)fp8;	// IMP=0x4d59718c
- (void)drawDataSetRect:(struct _NSRect)fp8;	// IMP=0x4d59789c
- (id)view:(id)fp8 stringForToolTip:(int)fp12 point:(struct _NSPoint)fp16 userData:(void *)fp24;	// IMP=0x4d597328
